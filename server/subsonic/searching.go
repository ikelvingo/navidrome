...
// searchMediaFilesWithVariants 使用多个查询变体搜索MediaFiles，用于中英文繁简体统一搜索
...
// searchAlbumsWithVariants 使用多个查询变体搜索Albums，用于中英文繁简体统一搜索
...
// searchArtistsWithVariants 使用多个查询变体搜索Artists，用于中英文繁简体统一搜索
